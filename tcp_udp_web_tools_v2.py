...
from PyQt5.QtWidgets import QApplication, QDialog, QMessageBox, QFileDialog, QHBoxLayout, QVBoxLayout, QGridLayout
import sys
import socket
import threading
import ctypes
...
class Ui_TCP(QDialog):
    ...
    def ui_translate(self, ):
        ...
        :return: None
        """
        self.setWindowTitle(self._translate("TCP-UDP", "TCP网络测试工具"))
        ...
        self.label_written.setText(self._translate("TCP-UDP", "Written by python-4期 李多"))
